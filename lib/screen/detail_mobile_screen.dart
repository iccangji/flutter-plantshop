                      ...
                      return Column(
                        ...
                        SizedBox(
                          ...
                          child: ListView(
                                ...
                                itemExtent: MediaQuery.of(context).size.width - 32.0,
                                children: <Widget>[
                                ClipRRect(
            ...
            Row(
              children: [
                ...
                child: Padding(
                  ...
                  child: FilledButton(
                  style: ButtonStyle(
                    backgroundColor: _isCartItem ? MaterialStatePropertyAll(Theme.of(context).colorScheme.secondary) : MaterialStatePropertyAll(Theme.of(context).colorScheme.primary)
                  ),
                  onPressed: (){
                    setState(() {
                      setState(() {
                  ...
                  plantList[plantList.indexOf(widget.plant)].cart = _isCartItem;
                  },
                  child: Text(
                    _isCartItem ? "Added to Cart" : "Add to Cart"
                  )
              ),
                )
              )
